...
2. Clone your fork: `git clone https://github.com/your-username/wc-product-upload-with-uppy.git`
...
### Installation
```bash
git clone https://github.com/wp-spaghetti/wc-product-upload-with-uppy.git
cd wc-product-upload-with-uppy
composer install
   ```
